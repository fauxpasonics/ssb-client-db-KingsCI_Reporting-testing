...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF_ProdCopy_Campaign] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Campaign] ADD CONSTRAINT [PK__Campaign__3214EC072674CE3B] PRIMARY KEY CLUSTERED  ([Id])
GO
