...
[loaddate] [datetime] NULL CONSTRAINT [DF__User__loaddate__4A6E022D] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[User] ADD CONSTRAINT [PK__User__3214EC07DD4AD384] PRIMARY KEY CLUSTERED  ([Id])
GO
