...
[loaddate] [datetime] NULL CONSTRAINT [DF__Contact__loaddat__162F4418] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IX_PC_Conact_AccountID] ON [prodcopy].[Contact] ([AccountId]) INCLUDE ([Archtics_ID__c])
GO
CREATE NONCLUSTERED INDEX [idx_id] ON [prodcopy].[Contact] ([Id])
GO
CREATE NONCLUSTERED INDEX [IX_PC_Contact_isdeleted] ON [prodcopy].[Contact] ([IsDeleted]) INCLUDE ([Archtics_ID__c], [Id])
GO
CREATE NONCLUSTERED INDEX [IX_PC_Cont_isdel] ON [prodcopy].[Contact] ([IsDeleted]) INCLUDE ([Archtics_ID__c], [Id], [Name])
GO
