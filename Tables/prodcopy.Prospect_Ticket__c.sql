CREATE TABLE [prodcopy].[Prospect_Ticket__c]
(
...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Prospect___CopyL__150615B5] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Prospect_Ticket__c] ADD CONSTRAINT [PK_ProdCopy_Prospect_Ticket__c] PRIMARY KEY CLUSTERED  ([Id])
GO
