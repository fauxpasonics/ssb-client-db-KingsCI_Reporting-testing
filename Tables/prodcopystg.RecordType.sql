...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF_ProdCopy_RecordType] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[RecordType] ADD CONSTRAINT [PK__RecordTy__3214EC07B609E728] PRIMARY KEY CLUSTERED  ([Id])
GO
