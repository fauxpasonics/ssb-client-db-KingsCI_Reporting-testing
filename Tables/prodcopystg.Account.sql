...
[loaddate] [datetime] NOT NULL CONSTRAINT [DF__Account__loaddat__19CACAD2] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Account] ADD CONSTRAINT [PK_Account] PRIMARY KEY CLUSTERED  ([Id])
GO
