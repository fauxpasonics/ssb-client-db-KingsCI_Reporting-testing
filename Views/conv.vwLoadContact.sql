...
CREATE VIEW [conv].[vwLoadContact] AS 
SELECT --TOP 1000 
--a.[Id]
--,a.[IsDeleted]
...
,cx.TotalTicketSpend_Previous Total_Kings_Tix_revenue_Previous_Season__c
...
,cx.TE_Seat_NumForward_Previous Num_seats_forwarded_Previous_Season__c
,cx.TE_Seat_NumPost_Previous Num_seats_posted_Previous_Season__c
,cx.TE_Seat_NumSold_Previous Num_seats_resold_Previous_Season__c
...
,cx.TE_Revenue_Current	 Tot_Rev_seats_bought_resale_TM_Plus_CS__c
,cx.TE_Revenue_Previous  Tot_rev_seats_bought_resale_TM_Plus_PS__c
...
--into loadContact0831 --drop table loadContact0831
...
LEFT OUTER JOIN Contact_xRef_Single_First x-- [conv].[vwContact_xRef_Single_First] x--select * into [Contact_xRef_Single_First]  from  [conv].[vwContact_xRef_Single_First]  drop table Contact_xRef_Single_First
